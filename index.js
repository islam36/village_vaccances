...
app.listen(PORT, () => {
    console.log(`VEILLEZ LAISSER CETTE FENETRE OUVERTE PEDANT L'UTILISATION DU LOGICIEL`);
    console.log(`Une fois vous terminez, vous pouvez la fermer`);
    console.log(`Si l'interface du logiciel n'est pas lancée, vous pouvez ouvrir votre navigateur et tapez dans la barre: http://localhost:8000`);
})
